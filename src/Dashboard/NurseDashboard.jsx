...
function NurseDashboard({ navigate }) {
  ...
  const addPatientToSupervise = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setAddPatientError(
          err.message ||
            `Error ${res.status} — patient not found or already assigned.`,
        );
      }
    } catch (e) {
  ...
  return (
    <div className="nd-root">
      {sidebarOpen && (
        <div className="nd-overlay" onClick={() => setSidebar(false)} />
      )}
        ...
        >
          <div className="nd-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <p className="nd-modal-desc">
              Enter the patient ID to add them to your supervision list. The
            ...
            <div className="nd-modal-body">
              ...
              <input
                ...
                onChange={(e) =>
                  setAddPatientForm({ patientId: e.target.value })
                }
          ...
          {NAV.map((item) => (
            ...
            >
              ...
              {item.id === "alerts" && visAlerts.length > 0 && (
                <span
                  className={`nd-nav-badge ${criticalCount > 0 ? "nd-nav-badge--critical" : "nd-nav-badge--warn"}`}
                >
                  {visAlerts.length}
                </span>
              )}
        ...
        <div className="nd-sidebar-bottom">
          <div className="nd-nurse-card">
            <div className="nd-nurse-avatar">
              {nurseData
                ? initials(`${nurseData.firstName} ${nurseData.lastName}`)
                : "…"}
            </div>
      ...
      <main className="nd-main">
        <header className="nd-topbar">
          ...
          <div className="nd-topbar-right">
            ...
            {navigate && (
              <button
                className="nd-btn-ghost nd-back-btn"
            ...
            <div className="nd-section fade-in">
              <div className="nd-welcome-banner">
                <div>
                  ...
                  <h2 className="nd-welcome-name">
                    {nurseData?.firstName || "Nurse"}{" "}
                    {nurseData?.lastName || ""}
                  </h2>
                </div>
              ...
              <div className="nd-stats-grid">
                {[
                  ...
                  <div
                    key={i}
                    className={`nd-stat-card nd-stat-card--${s.variant}`}
                  >
                        ...
                        return (
                          <div key={p.id} className="nd-critical-card">
                            <div className="nd-critical-left">
                              <div className="nd-avatar nd-avatar--critical">
                                {initials(`${p.firstName} ${p.lastName}`)}
                              </div>
                              <div>
                                <div className="nd-patient-name">
                              ...
                              <div className="nd-critical-vitals">
                                {[
                                  ...
                                  <div key={l} className="nd-crit-vital">
                                    <div className="nd-crit-vital-label">
                                      {l}
                                    </div>
                                    <div className="nd-crit-vital-val">
                                      {val}
                                      <span className="nd-crit-vital-unit">
                                        {u}
                                      </span>
                                    </div>
                                  </div>
                  ...
                  {pendingAppts.slice(0, 5).map((a) => (
                    <div key={a.id} className="nd-appt-row">
                      ...
                      <div className="nd-appt-info">
                        <div className="nd-appt-name">
                          {a.patientName || a.patient}
                        </div>
                        <div className="nd-appt-type">
                          {a.type} · {a.room}
                        </div>
                      </div>
                ...
                <>
                  ...
                  <div className="nd-alert-list">
                    {visAlerts.slice(0, 3).map((a) => (
                      <div
                        key={a.id}
                        className={`nd-alert-card nd-alert-card--${a.type}`}
                      >
                        <div className="nd-alert-left">
                          <div
                            className={`nd-alert-dot nd-alert-dot--${a.type}`}
                          />
                          <div>
                            <div className="nd-alert-patient">
                              {a.patientName || a.patient}{" "}
                              <span className="nd-alert-room">· {a.room}</span>
                            </div>
              ...
              {selPatient ? (
                <>
                  ...
                  <div className="nd-patient-detail">
                    <div className="nd-patient-detail-header">
                      <div
                        className={`nd-avatar nd-avatar--accent nd-avatar--lg`}
                      >
                        {initials(
                      ...
                      <div className="nd-patient-detail-info">
                        ...
                        <p>
                          ...
                          {selPatient.admitted
                            ? ` · Admitted ${selPatient.admitted}`
                            : ""}
                        </p>
                        {selPatient.diagnosis && (
                          <p className="nd-patient-diag">
                            {selPatient.diagnosis}
                          </p>
                        )}
                      </div>
                      ...
                      <>
                        ...
                        <div className="nd-vitals-row">
                          {[
                            [
                              "Heart Rate",
                              liveVitals[selPatient.id].heartRate,
                              "bpm",
                            ],
                            [
                              "Blood Pressure",
                              liveVitals[selPatient.id].bloodPressure,
                              "mmHg",
                            ],
                            ["SpO₂", liveVitals[selPatient.id].spo2, "%"],
                            [
                              "Temperature",
                              liveVitals[selPatient.id].bodyTemperature,
                              "°C",
                            ],
                            [
                              "Glucose",
                              liveVitals[selPatient.id].glucoseLevel,
                              "mg/dL",
                            ],
                          ].map(([label, val, unit]) => (
                            <div key={label} className="nd-vital-pill">
                              <div className="nd-vital-pill-label">{label}</div>
                              <div className="nd-vital-pill-value">
                                {val ?? "—"}
                                <span className="nd-vital-pill-unit">
                                  {unit}
                                </span>
                              </div>
                            </div>
                            ...
                            .map((a) => (
                              ...
                              >
                                <div className="nd-alert-left">
                                  ...
                                  />
                                  <div>
                                    <div className="nd-alert-msg">
                                      {a.message}
                                    </div>
                                    <div className="nd-alert-time">
                                      {a.time}
                                    </div>
                                  </div>
                                </div>
                ...
                <>
                  <div className="nd-patients-toolbar">
                    <p className="nd-patients-count">
                      {patients.length} patient
                      {patients.length !== 1 ? "s" : ""} under your care
                    </p>
                    <button
                      className="nd-btn-primary nd-btn-add-patient"
                      onClick={() => setShowAddPatient(true)}
                    >
                      <span className="nd-btn-icon">
                        <PlusIcon />
                      </span>
                      Add Patient
                    </button>
                  ...
                  {patients.length === 0 ? (
                    <div className="nd-empty-patients">
                      ...
                      />
                      <button
                        className="nd-btn-primary nd-btn-add-empty"
                        onClick={() => setShowAddPatient(true)}
                      >
                        <span className="nd-btn-icon">
                          <PlusIcon />
                    ...
                    <div className="nd-patient-grid">
                      {patients.map((p) => (
                        <div
                          key={p.id}
                          className="nd-patient-card"
                          onClick={() => setSelPat(p)}
                        >
                          <div className="nd-patient-card-top">
                            <div
                              className={`nd-avatar nd-avatar--${condColor(p.condition)}`}
                            >
                              {initials(`${p.firstName} ${p.lastName}`)}
                            </div>
                            <Badge
                          ...
                          <div className="nd-patient-card-name">
                            {p.firstName} {p.lastName}
                          </div>
                          <div className="nd-patient-card-sub">
                            {p.room} · Age {p.age}
                          </div>
                          {p.diagnosis && (
                            <div className="nd-patient-card-diag">
                              {p.diagnosis}
                            </div>
                          )}
                        </div>
          ...
          {active === "vitals" && (
            <div className="nd-section fade-in">
              {patients.length === 0 ? (
                <EmptyState
                  icon={<HeartIcon />}
                  title="No patients to display"
                  sub="Add patients to supervision to view vitals."
                />
              ) : (
                          ...
                          >
                            <td>
                              <div className="nd-table-patient">
                                <div
                                  className={`nd-avatar nd-avatar--sm nd-avatar--${condColor(p.condition)}`}
                                >
                                  {initials(`${p.firstName} ${p.lastName}`)}
                                </div>
                                {p.firstName} {p.lastName}
                            ...
                            <td
                              className={`nd-mono ${v?.heartRate > 100 ? "nd-val--warn" : ""}`}
                            >
                              {v?.heartRate ?? "—"}
                            </td>
                            ...
                            <td
                              className={`nd-mono ${v?.spo2 < 95 ? "nd-val--critical" : ""}`}
                            >
                              {v?.spo2 ?? "—"}
                            </td>
                            <td
                              className={`nd-mono ${v?.bodyTemperature > 38 ? "nd-val--warn" : ""}`}
                            >
                              {v?.bodyTemperature ?? "—"}
                            </td>
                            <td className="nd-mono">
              ...
              <p className="nd-table-notice">
                Values highlighted in red/amber indicate readings outside the
                normal range. Verify with patient immediately.
              </p>
            </div>
          )}
                      ...
                      .map((a) => (
                        <div key={a.id} className="nd-appt-full-card">
                          ...
                          <div className="nd-appt-full-body">
                            <div className="nd-appt-full-name">
                              {a.patientName || a.patient}
                            </div>
                            <div className="nd-appt-full-meta">
                              {a.type} · {a.room}
                            </div>
                          </div>
                          <Badge label="Pending" variant="warn" />
            ...
            <div className="nd-section fade-in">
              ...
              {meds.length === 0 ? (
                <EmptyState
                  ...
                  sub="No active medication rounds at this time."
                />
              ) : (
                <div className="nd-med-list">
                  {meds.map((m) => (
                    <div
                      key={m.id}
                      className={`nd-med-card ${m.given || m.takenToday ? "nd-med-card--taken" : ""}`}
                    >
                      <div className="nd-med-left">
                        <div className="nd-med-room-badge">{m.room}</div>
                        <div>
                          <div className="nd-med-name">
                            {m.patientName || m.patient}
                          </div>
                          <div className="nd-med-detail">
                            {m.medicationName || m.name || m.med}{" "}
                            {m.dosage || m.dose
                              ? `· ${m.dosage || m.dose}`
                              : ""}
                          </div>
                          <div className="nd-med-time">
                            {m.time || m.frequency}
                          </div>
                        </div>
                      </div>
            ...
            <div className="nd-section fade-in">
              <div className="nd-form-card">
                ...
                <div className="nd-form-row">
                  ...
                  />
                  <button className="nd-btn-primary" onClick={addTask}>
                    Add
                  </button>
                </div>
              </div>
              ...
              <div className="nd-task-list">
                {tasks
                  ...
                  .map((t) => (
                    <div
                      key={t.id}
                      className="nd-task-card"
                      onClick={() => toggleTask(t.id)}
                    >
                      <div
                        className={`nd-task-circle nd-task-circle--${t.priority}`}
                      />
                  ...
                  <div className="nd-task-list">
                    {tasks
                      ...
                      .map((t) => (
                        <div
                          key={t.id}
                          className="nd-task-card nd-task-card--done"
                          onClick={() => toggleTask(t.id)}
                        >
                          <div className="nd-task-circle nd-task-circle--done">
                            ✓
                          </div>
                          <div className="nd-task-text nd-task-text--done">
                            {t.text}
                          </div>
                        </div>
                      ))}
            ...
            <div className="nd-section fade-in">
              {reports.length === 0 ? (
                <EmptyState
                  ...
                  sub="Reports for your patients will appear here."
                />
              ) : (
                      ...
                      <div className="nd-report-left">
                        ...
                        <div>
                          ...
                          <div className="nd-report-sub">
                            {r.patientName || r.patient} · {r.date}
                          </div>
                        </div>
                      </div>
