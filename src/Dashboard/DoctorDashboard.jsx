        ...
        >
          <div className="nd-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <p className="nd-modal-desc">
              Enter the patient ID to add them to your supervision list.
            </p>
                    ...
                    >
                      ...
                      <div className="dd-appt-info">
                        ...
                        <div className="dd-appt-type">
                          {a.appointmentName || a.type} · {a.room}
                        </div>
                      </div>
                      <Badge
                      ...
                      <>
                        ...
                        <div className="dd-vitals-row">
                          {[
                            ...
                            [
                              "Resp. Rate",
                              liveVitals[selPatient.id].respiratoryRate,
                              "br/min",
                            ],
                          ].map(([label, val, unit]) => (
                    ...
                    <div className="dd-patient-grid">
                      {patients.map((p) => (
                        ...
                        >
                          ...
                          <div className="dd-patient-card-name">
                            {p.firstName} {p.lastName}
                          </div>
            ...
            <div className="dd-section fade-in">
              {patients.length === 0 ? (
                <EmptyState
                  ...
                  sub="Add patients to view vitals."
                />
              ) : (
                      ...
                      {patients.map((p) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <td
                              className={`dd-mono ${v?.heartRate > 100 ? "dd-val--warn" : ""}`}
                            >
                              {v?.heartRate ?? "—"}
                            </td>
                            ...
                            <td
                              className={`dd-mono ${v?.bodyTemperature > 38 ? "dd-val--warn" : ""}`}
                            >
                              {v?.bodyTemperature ?? "—"}
                            </td>
                            <td
                              className={`dd-mono ${v?.respiratoryRate > 20 ? "dd-val--warn" : ""}`}
                            >
                              {v?.respiratoryRate ?? "—"}
                            </td>
                            <td>
              ...
              {appointments.length === 0 ? (
                ...
                <div className="dd-appt-full-list">
                  {appointments.map((a) => (
                    ...
                    >
                      <div className="dd-appt-full-time">
                        {a.appointmentTime || a.time || "TBD"}
                      </div>
                      <div className="dd-appt-full-body">
                        <div className="dd-appt-full-name">
            ...
            <div className="dd-section fade-in">
              {labs.length === 0 ? (
                <EmptyState
                  ...
                  sub="Lab records will appear here when ready."
                />
              ) : (
            ...
            <div className="dd-section fade-in">
              ...
              {procedures.length === 0 ? (
                <EmptyState
                  icon={<ProcIcon />}
                  title="No Procedures"
                  sub="Scheduled procedures will appear here."
                />
              ) : (
                  ...
                  {procedures.map((p, i) => (
                    <div key={p.id || i} className="dd-proc-card">
                      <div className="dd-proc-left">
                        <div className="dd-proc-name">
                          {p.name || p.procedure}
                        </div>
                        <div className="dd-proc-patient">
                      ...
                      <Badge
                        ...
                        variant={
                          p.status === "pending approval" ? "warn" : "normal"
                        }
                      />
                    </div>
                  ))}
